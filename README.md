...
This an example of how to install a SLURM cluster:
    ...
    - hosts: server
      roles:
      - { role: 'grycap.slurm', slurm_type_of_node: 'front', slurm_server_ip: '{{ansible_default_ipv4}}', slurm_wn_ips: "{{ groups['wns']|map('extract', hostvars, 'ansible_default_ipv4')|list }}" }
